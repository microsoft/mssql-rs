...
//!
//! [`PyCoreSyncCursor`] shares the same [`SharedClient`] cell as the async
//! [`PyCoreCursor`](crate::cursor::PyCoreCursor); it exposes an identical DB-API
...
impl PyCoreSyncCursor {
    ...
    fn close(&mut self, py: Python) -> PyResult<()> {
        ...
        // work; best-effort, matching the async cursor's non-draining close.
        py.detach(|| {
