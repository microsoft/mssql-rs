...
#   EXPECTED_PLATFORM_TAG  Substring the produced wheel's platform tag must contain (manylinux /
#                          musllinux). Required: a job that runs this script twice would otherwise
#                          see the first invocation's wheels and never be able to fail.
